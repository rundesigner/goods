...
public class YandexParser {
    ...
    public static String baseurl = "market.yandex.ru";
    ...
    public static void main(String[] args) {
        try {
            ...
            //getPoisk(params.get("sku").toString());
...
//            urlConn.setRequestProperty("Cache-Control", "max-age=0");
    ...
    public static TagNode getPoisk(String pname) {
        ...
        try {
            ...
            //https://yandex.ru/suggest-market/suggest-market?callback=jQuery18208690318911065118_1454541223985&sk=u55e039a7420f813feed39fc97ef8c79b&srv=market&wiz=TrWth&part=j&pos=1&svg=1&_=1454541265631
            //searche = "https://yandex.ru/suggest-market/suggest-market?callback=jQuery18208690318911065118_1454541223985&sk=u55e039a7420f813feed39fc97ef8c79b&srv=market&wiz=TrWth&part=" + URLEncoder.encode(pname.toLowerCase(), "utf-8") + "&pos=1&svg=1&_=1454541265631";
            //searche = "https://yandex.ru/suggest-market/suggest-market?callback=jQuery18208519864227047729_1454546783821&sk=u61ab9e55115bbe9b339504bbf8a5db8d&srv=market&wiz=TrWth&part=" + URLEncoder.encode(pname.toLowerCase(), "utf-8") + "&pos=2&svg=1&_=1454546826344";
            searche = "https://market.yandex.ru/search.xml?cvredirect=2&text=" + URLEncoder.encode(pname.toLowerCase(), "utf-8") + "";
            t = getTag(searche);
...
//
//            String suggest = t.getText() + "";
//             Messages.show("mess=" + suggest);
//            suggest = java.net.URLDecoder.decode(suggest, "UTF-8");
//            suggest = suggest.split("[\\(\\)]")[1];
//            JSONParser parser = new JSONParser();
//
//            Object obj = parser.parse(suggest);
...
//            names = names.split("[\\[\\]]")[1];
//            String[] arnames = names.split(",");
//            //  Messages.show(Arrays.toString(arnames));
//
//            String urls = iterator.next() + "";
//            urls = urls.split("[\\[\\]]")[1];
//            String[] arurls = urls.split(",");
//            //   Messages.show(Arrays.toString(arurls));
//
//            String prod_url = "";
//            for (String s : arurls) {
//                if (s.length() > 5) {
//                    
//                    Messages.show("s=" + s.substring(2));
//                    if (s.substring(2).startsWith("/model.xml?modelid=")) {
//                        Messages.show("Урл найден");
//                        prod_url = s.substring(2,s.length()-1);
//                        break;
//                    }
//                }
//            }
//            if (!(prod_url.length() > 0)) {
//                Messages.show("Товар не найден");
//                return resultMap;
//            }
//            Messages.show("https://market.yandex.ru" + prod_url);
            // https://market.yandex.ru/model.xml?modelid=12458285&hid=91052&suggest=1

//              //  Iterator<String> iterator3 = iterator2.next().iterator();
//                //while (iterator3.hasNext()) {
//                    Messages.show(iterator2.next());
//                //}
//            }


//                t = getTag("https://market.yandex.ru" + prod_url);
//                //малое описание
