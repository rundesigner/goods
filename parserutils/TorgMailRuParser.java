...
public class TorgMailRuParser {
    ...
    public static String baseurl = "torg.mail.ru";
    ...
    public static HashMap getDescription(HashMap param)
        ...
        try {
            ...
            found = t.evaluateXPath("//div[@class=\"listing_goods__list__pic\"]/a");
            t2 = (TagNode) found[0];
            if (found.length > 0) {
                Messages.show("Найдена ссылка на товар" + t2.getAttributeByName("href"));
                String file = "http://" + baseurl + t2.getAttributeByName("href");
                t = getTag(file);
            ...
            found = t.evaluateXPath("//*/div[@class='b-gallery-preview']/span/@data-href");

            if (found.length > 0) {
                String data_href = ((String) found[0]).split("=")[1]; //dom/chasy/naruchnye-chasy/fossil-ch2903-0
                bigpicture = "http://img-sotmarket.ru/1200x1200/img/" + data_href + ".jpg";
    ...
    public static TagNode getTag(String url) {
        ...
        try {
            ...
            e.printStackTrace();
            Messages.show("Ошибка getTag:" + e.getMessage());
        }
